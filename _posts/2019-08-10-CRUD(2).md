...
~~~html
<h5>
    <a href="{% raw %}{% url 'crud:read' item.id %} {% endraw %} "> 제목 : {{ item.title }} </a>
</h5>
~~~
...
<form action="{% raw %}{% url 'crud:update' post.id %}{% endraw %}" method="POST">
...
`read.html`
~~~html
<a href="{% raw %}{% url 'crud:edit' post.id %}{% endraw %}">수정</a>  <a href="#">삭제</a>
~~~
...
`read.html`
~~~html
<a href="{% raw %}{% url 'crud:edit' post.id %}{% endraw %}">수정</a>  <a href="{% raw %}{% url 'crud:delete' post.id %}{% endraw %}">삭제</a>
~~~
...
`read.html`
~~~html
<a href="{% raw %}{% url 'crud:edit' post.id %}{% endraw %}">수정</a>  
<form action="{% raw %}{% url 'crud:delete' post.id %}{% endraw %}" method="POST">
	{% raw %}{% csrf_token %}{% endraw%}
